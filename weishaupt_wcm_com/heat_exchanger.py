...
QUERYTELEGRAM_2 = (
    '{"prot":"coco","telegramm":[[10,0,1,3102,0,0,0,0],[10,0,1,700,0,0,0,0],[10,0,1,3158,0,0,0,0],[10,0,1,3159,0,0,0,0],[10,0,1,138,0,0,0,0],[10,0,1,2560,0,0,0,0],[10,0,1,31,0,0,0,0],[10,0,1,39,0,0,0,0],[10,0,1,34,0,0,0,0],[10,0,1,323,0,0,0,0],[10,0,1,345,0,0,0,0],[10,0,1,384,0,0,0,0]]}'
)
...
QUERIES = [
    ...
    [2560, "System Frost Protection", TEMP],
    [31, "Min Flow Temp", TEMP],
    [39, "Max Flow Temp", TEMP],
    [34, "Flow Temp Hysteresis", DECIMAL_VALUE],
    [323, "Burner Lockout Time", VALUE],
    [345, "Max DHW Output", DECIMAL_VALUE],
    [384, "Max DHW Charge Time", VALUE],
]
